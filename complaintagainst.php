<?php
      ...
      if (isset($_POST['b1'])  && !empty($_POST['q1'])) {   
            $i = rand(10000,50000);                       
            mysqli_query($conn,
                  "insert into complaint_against_person set
                        name  = '".$_POST['q1']."'  ,
             ...
             {
                  echo
                  "<b>Your Complaint registered Successfully<br>your Complaint no is $i .
                    kindly remember this number for further assistance";
             }           
         }
?>
...
<html lang="en">
 <head>
    ...
    <title>Register your complaint Against a Person</title>
    <style type="text/css">
        .registerform{
            margin-top: 5%;
            width:50vw;
  ...
  <body>
       <h1 align ="center" style="color:red;">
          Register Your Complaint Against a Person</h1>
