...
<head>
    <meta charset="UTF-8">
    <title>NSU All Complains Against Person</title>
...
<body>
    <section>
        <h1>NSU Complaint Box Against Person</h1>
        <!-- TABLE CONSTRUCTION-->
        <table>
            <tr>
    ...
    <center> <a href="user-seeall.php" class="button1">Go Back</a></center><br>
    <center>  <a href="dashboard.php" class="button1">Back to dashboard</a></center>
</body>
